...
LDFLAGS += -s WASM=1
LDFLAGS += -s ASYNCIFY
LDFLAGS += -s EXPORTED_FUNCTIONS="_free,_malloc,_mp_js_init,_mp_js_init_with_heap,_mp_js_repl_init,_mp_js_repl_process_char,_mp_hal_get_interrupt_char,_mp_js_do_exec,_mp_js_do_exec_async,_mp_js_do_import,_mp_js_register_js_module,_proxy_c_init,_proxy_c_free_obj,_proxy_c_to_js_call,_proxy_c_to_js_delete_attr,_proxy_c_to_js_dir,_proxy_c_to_js_get_array,_proxy_c_to_js_get_dict,_proxy_c_to_js_get_iter,_proxy_c_to_js_get_type,_proxy_c_to_js_has_attr,_proxy_c_to_js_iternext,_proxy_c_to_js_lookup_attr,_proxy_c_to_js_resume,_proxy_c_to_js_store_attr,_proxy_convert_mp_to_js_obj_cside"
LDFLAGS += -s EXPORTED_RUNTIME_METHODS="ccall,cwrap,FS,getValue,setValue,stringToUTF8"
